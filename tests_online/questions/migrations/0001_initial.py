# Generated by Django 2.2 on 2019-04-30 11:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('params', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=32), default=questions.models.test._params__default, size=None, verbose_name='Parameters')),
                ...
                ('stats_restriction', models.CharField(choices=[(questions.models.test.TestStatsChoices('off'), 'off'), (questions.models.test.TestStatsChoices('any'), 'any'), (questions.models.test.TestStatsChoices('auth_only'), 'auth_only'), (questions.models.test.TestStatsChoices('private'), 'private')], default=questions.models.test.TestStatsChoices('off'), max_length=16, verbose_name='Statistic restriction')),
